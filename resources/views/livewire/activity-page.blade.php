                ...
                <div class="w-full mb-12 xl:pr-16 xl:mb-0">
                    ...
                    <div class="p-4 flex justify-center items-center flex-wrap">
                        ...
                        <span class="inline-flex items-center m-2 px-2 py-1 bg-gray-200 hover:bg-gray-300 rounded-full text-sm font-semibold text-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 h-4 fill-current" viewBox="0 0 16 16">
                        ...
                        <span class="inline-flex items-center m-2 px-3 py-1 bg-green-200 hover:bg-green-300 rounded-full text-sm font-semibold text-green-600">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-4 w-4 fill-current" viewBox="0 0 16 16">
                                <path d="M8.5 5.5a.5.5 0 0 0-1 0v3.362l-1.429 2.38a.5.5 0 1 0 .858.515l1.5-2.5A.5.5 0 0 0 8.5 9z"/>
                                <path d="M6.5 0a.5.5 0 0 0 0 1H7v1.07a7.001 7.001 0 0 0-3.273 12.474l-.602.602a.5.5 0 0 0 .707.708l.746-.746A6.97 6.97 0 0 0 8 16a6.97 6.97 0 0 0 3.422-.892l.746.746a.5.5 0 0 0 .707-.708l-.601-.602A7.001 7.001 0 0 0 9 2.07V1h.5a.5.5 0 0 0 0-1zm1.038 3.018a6 6 0 0 1 .924 0 6 6 0 1 1-.924 0M0 3.5c0 .753.333 1.429.86 1.887A8.04 8.04 0 0 1 4.387 1.86 2.5 2.5 0 0 0 0 3.5M13.5 1c-.753 0-1.429.333-1.887.86a8.04 8.04 0 0 1 3.527 3.527A2.5 2.5 0 0 0 13.5 1"/>
                            </svg>
                            <span class="ml-1">Task resets in:</span>
                        </span>
                        ...
                        <div class="w-full mt-4 flex justify-center space-x-4">
                            ...
                            <!-- Information label -->
                            <div class="flex items-center rounded-full py-1 px-4 font-medium border text-green-900 bg-green-100 border-green-300">
                                Order Commission :
                                <span class="flex items-center ml-2 font-bold">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-5 w-5 mr-1" viewBox="0 0 16 16">
                            ...
                            <button wire:click="completeTask" class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded">
                                Complete Task
                            </button>
