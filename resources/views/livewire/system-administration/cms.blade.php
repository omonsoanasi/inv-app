...
{{--                            <div class="">--}}
{{--                                <!-- Modal toggle -->--}}
{{--                                <button onclick="editActivity({{ $activity->id }})" data-modal-target="edit-activity-modal-{{ $activity->id }}" data-modal-toggle="edit-activity-modal-{{ $activity->id }}"--}}
{{--                                        class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"--}}
{{--                                        type="button">--}}
{{--                                    Edit Activity--}}
{{--                                </button>--}}
...
{{--                                                <button type="button"--}}
{{--                                                        class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"--}}
{{--                                                        data-modal-hide="edit-activity-modal-{{ $activity->id }}">--}}
{{--                                                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"--}}
{{--                                                         fill="none" viewBox="0 0 14 14">--}}
{{--                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"--}}
{{--                                                              stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>--}}
...
{{--                                            <!-- Modal body -->--}}
{{--                                            <div class="p-4 md:p-5">--}}
{{--                                                <form wire:submit="updateActivity" type="multipart/enctype" class="space-y-4">--}}
{{--                                                    <div>--}}
{{--                                                        <label for="name"--}}
...
{{--                                                    <div>--}}
{{--                                                        <label for="commission"--}}
{{--                                                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Daily Tasks</label>--}}
{{--                                                        <input wire:model="daily_tasks" type="number" id="daily_tasks"--}}
{{--                                                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"--}}
{{--                                                               placeholder="10" required/>--}}
{{--                                                    </div>--}}
{{--                                                    <div>--}}
{{--                                                        <label for="commission"--}}
{{--                                                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Task Reset</label>--}}
{{--                                                        <select wire:model="task_reset" id="commission"--}}
{{--                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"--}}
{{--                                                                required>--}}
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5">
                                    <form wire:submit="saveActivity" type="multipart/enctype" class="space-y-4">
                                        ...
                                        <div>
                                            <label for="commission"
                                                   class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">User Type</label>
                                            <select wire:model="user_type" id="commission"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                    required>
                                                <option value="" selected>Select a user type</option>
                                                <option value="0">Not Subscribed</option>
                                                <option value="1">Subscribed Users</option>
                                            </select>
                                        </div>
                                        <button type="submit"
                                                class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
