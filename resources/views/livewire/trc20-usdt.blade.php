<section class="flex justify-center items-center bg-gray-100">
    <div class="wrapper bg-white rounded-lg shadow-lg overflow-hidden max-w-sm relative">
        ...
        <div class="absolute top-4 left-4">
            <button onclick="window.history.back()" class="flex items-center text-gray-600 hover:text-teal-600 transition duration-300">
        ...
        <div class="p-6 space-y-3">
            <div class="flex items-center justify-center space-x-2">
                ...
                <button onclick="copyToClipboard()" class="flex items-center text-teal-600 hover:text-teal-500 transition duration-300" title="Copy Address">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-5 w-5" viewBox="0 0 16 16">
